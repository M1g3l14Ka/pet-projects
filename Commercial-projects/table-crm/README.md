### Live Demo: https://next-tablecrm.vercel.app/
...
3.	Important:
- Create a .env.local file in the root directory and add your Resend API key to make the contact form work: GEMINI_API_KEY=your_api_key_here
